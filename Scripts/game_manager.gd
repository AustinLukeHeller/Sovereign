...
@onready var happiness_tooltip:Control= get_node("/root/Main/UI/TopBar/HappinessTooltip")
@onready var happiness_icon:AnimatedSprite2D = get_node("/root/Main/UI/TopBar/HappinessTooltip/HappinessIcon")

var player_faction:Faction

var all_zones: Dictionary[String, Zone] = {}
...
func update_happiness():
	...
	happiness_tooltip.tooltip_text = "Happiness: "+str(cur_happiness)
	if(cur_happiness > 15):
